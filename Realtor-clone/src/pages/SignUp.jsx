            ...
            <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
                ...
                <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
                    ...
                    <form onSubmit={onSubmit}>
                        <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out mb-3' type="text" value={name} onChange={onChange} id='name' placeholder='Full Name' />
                        ...
                        <button type="submit" className='w-full text-white bg-blue-600 px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out shadow-lg active:bg-blue-800 '>Sign Up</button>
